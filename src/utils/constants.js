...
export const icons = [
  { New: <AiFillHome /> },
  { Trending: <MdLocalFireDepartment /> },
  { Music: <CgMusicNote /> },
  { Films: <FiFilm /> },
  { Live: <MdLiveTv /> },
  { Gaming: <IoGameControllerSharp /> },
  { News: <ImNewspaper /> },
  { Sports: <GiDiamondTrophy /> },
  { Learning: <RiLightbulbLine /> },
  { "Fashion & beauty": <GiEclipse /> },
  { Settings: <FiSettings /> },
  { "Report History": <AiOutlineFlag /> },
  { Help: <FiHelpCircle /> },
  { "Send feedback": <RiFeedbackLine /> },
];
